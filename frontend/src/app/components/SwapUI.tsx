            ...
            <div className="flex flex-col gap-1">
                ...
                <div className="flex flex-col px-3">
                    <div className="flex flex-col flex-1 gap-3 text-baseTextHighEmphasis">
                        ...
                        <div className="flex flex-col gap-2">
                            ...
                            <div className="flex flex-col relative">
                                <input onChange={(e)=>{setPrice(e.target.value)}} step="0.01" placeholder="0" className="h-12 rounded-lg border-2 border-solid border-baseBorderLight bg-[var(--background)] pr-12 text-right text-2xl leading-9 text-[$text] placeholder-baseTextMedEmphasis ring-0 transition focus:border-accentBlue focus:ring-0" type="text" value={price} />
                    ...
                    <div className="flex flex-col gap-2">
                        ...
                        <div className="flex flex-col relative">
                            <input onChange={(e)=>{setQuantity(e.target.value)}} step="0.01" placeholder="0" className="h-12 rounded-lg border-2 border-solid border-baseBorderLight bg-[var(--background)] pr-12 text-right text-2xl leading-9 text-[$text] placeholder-baseTextMedEmphasis ring-0 transition focus:border-accentBlue focus:ring-0" type="text" value={quantity} />
                            <div className="flex flex-row absolute right-1 top-1 p-2">
                                <div className="relative">
